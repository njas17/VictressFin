  ...
  data(){
    return{
      questions:[
        ...
        {
          question:"Pay Equity. Formula: Women/men 12month compensation ratio for salaried employees (percent of women’s to men’s)",
            propositions:[
            {props:'0 to 60%'},
            {props:'61% to 85%'},
        ...
        {
          question:"Leadership and Governance:Women’s board or/and management representation (percent of members)",
          propositions:[
            {props:'0% to 10%',},
            {props:'11% to 45%'},
        ...
        {
          question:"Value Chain: Do you have approach to target women customers with your products and/services",
          propositions:[
            {props:'No'},
            {props:'Somewhat'},
        ...
        {
          question:"Benefits&Professional development: Do you have policies or approach to ensure non-discrimination and equal opportunity in  performance review and promotion processes",
          propositions:[
            {props:'Nothing',},
            {props:'Somewhat'},
            {props:'Yes', correct: true,},
        ...
        {
          question:"Safety and health:Do you have policies to address sexual harassment and gender-based violence in the workplace ?",
          propositions:[
            {props:'Yes', correct:true},
