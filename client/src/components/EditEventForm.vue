        ...
        <v-card-text>
            ...
            <!-- <div class="edit-form py-3"> -->
                ...
                <ValidationProvider v-slot="{ errors }" name="Location" rules="required" autocomplete="off">
                    <v-text-field v-model="currentevent.location" :error-messages="errors" label="Location" required>
                    </v-text-field>
                </ValidationProvider>
                ...
                <ValidationProvider v-slot="{ errors }" name="Email" rules="email" autocomplete="off">
                    <v-text-field v-model="currentevent.contactemail" :error-messages="errors" label="Email (optional)">
                    </v-text-field>
                </ValidationProvider>
                ...
                <ValidationProvider>
                    <template>
                        <v-text-field v-model="currentevent.images" prepend-icon="mdi-camera" show-size label="Image URL (http//:)"></v-text-field>
