...
con.connect(function(err) {
  ...
  let sqlInsert = "insert into organizations (name, website, telephone) values ('Cikgu Harry Bikal', 'https://www.thestar.com.my/news/nation/2020/07/13/superhero-teacher-looking-for-volunteers', ''), ('Altruistik Malaysia', 'https://myaltruistik.wixsite.com/myaltruistik', 'myaltruistik@gmail.com'), ('Caremongering Malaysia', 'https://www.facebook.com/groups/653716671867349/', '+60196691881'), ('House of Hope', 'https://www.facebook.com/houseofhopepenang', '04-826 4826'), ('Personal/Individual', 'N/A', null), ('Others', 'N/A', null); "
    ...
    + "insert into events (name, closingdate, status, description, location, organizer_id, contactname, contactnum, totalvolunteer, images) values ('Programme Charity Hike 2020', '2021-12-1', 'active', 'Malaysians who are moved by the inspiring story of a teacher that carried a refrigerator for 10km on foot to a remote school are encouraged to join him on another arduous task. JCI Kota Kinabalu, a non-governmental organisation, has donated more than 20 mattresses and hostel items for the school’s pupils. But there is one major obstacle – transporting the items to the school. So, if you are physically fit and adventurous enough to join the next hike - click Apply to register.', 'Pitas, Sabah, Malaysia', 1, 'Mary Michael', '0133244400', 8, 'https://firebasestorage.googleapis.com/v0/b/sehati-sejiwa.appspot.com/o/tanjir-ahmed-chowdhury-lnZ3XPAYbSk-unsplash.jpg?alt=media&token=d39f9f04-597c-4ec5-96e0-5e6e3f36ff24'), ('Humanitarian, Disaster & Crisis Management Volunteer Recruitment', '2020-02-29', 'active', 'The Altruistik Malaysia Humanitarian, Disaster, & Crisis Management open the opportunity for all legally resident in Malaysia, to carry out a national/ international volunteer service in Malaysia, Europe, Africa, Asia or South America affected area. Interested applicant click on Apply button to register.', 'Nationwide, Malaysia', 2, 'Tommy Lee', '0350001289', 6, 'https://firebasestorage.googleapis.com/v0/b/sehati-sejiwa.appspot.com/o/pexels-photo-6646897.jpeg?alt=media&token=39718d9f-db9d-469c-9d13-55f507e406d5'), ('Autism (ASD) Activist Recruitment', '2020-02-29', 'active', 'Call for State(Malaysia) Autism Spectrum Disorder SDG4 Activist. This project envisions to refocused effort to improve the quality of the education and acceptance among-st the community towards ASD. Acceptance in education along the lines of gender, urban-rural location and other dimensions still run deep, and more investments in education infrastructure are required.This campaign intends to enroll 80 State Activist across the Malaysia and raise voice in form of solidarity.', 'Nationwide, Malaysia', 2, 'Salina Salleh', '03500001290', 8, 'https://firebasestorage.googleapis.com/v0/b/sehati-sejiwa.appspot.com/o/photo-kids.jfif?alt=media&token=3d5f9792-0cb9-4d5d-93d6-a3f03a99d6ea'); "
