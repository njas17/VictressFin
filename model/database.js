...
con.connect(function(err) {
  ...
  let sql =
    ...
    + "CREATE TABLE `events` (`eid` INT NOT NULL AUTO_INCREMENT PRIMARY KEY, `name` VARCHAR(255) NOT NULL, `datefrom` DATE, `dateto` DATE, `closingdate` DATE NOT NULL, `status` VARCHAR(20) NOT NULL, `description` TEXT NOT NULL, `images` TEXT, `organizer_id` int NOT NULL, `contactname` VARCHAR(255), `contactnum` VARCHAR(255), `totalvolunteer` INT NOT NULL, FOREIGN KEY (`organizer_id`) REFERENCES `users`(`uid`)); "
