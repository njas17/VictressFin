...
con.connect(function(err) {
  ...
  let sqlInsert = "insert into organizations (name, website, telephone) values ('Cikgu Harry Bikal', 'https://www.thestar.com.my/news/nation/2020/07/13/superhero-teacher-looking-for-volunteers', ''), ('Altruistik Malaysia', 'https://myaltruistik.wixsite.com/myaltruistik', 'myaltruistik@gmail.com'), ('Caremongering Malaysia', 'https://www.facebook.com/groups/653716671867349/', '+60196691881'), ('House of Hope', 'https://www.facebook.com/houseofhopepenang', '04-826 4826'), ('Personal/Individual', 'N/A', null), ('Others', 'N/A', null); "
    ...
    + "insert into events (name, closingdate, status, description, organizer_id, contactname, contactnum, totalvolunteer, images) values ('Programme Charity Hike 2020', '2021-12-1', 'active', 'Malaysians who are moved by the inspiring story of a teacher that carried a refrigerator for 10km on foot to a remote school are encouraged to join him on another arduous task. JCI Kota Kinabalu, a non-governmental organisation, has donated more than 20 mattresses and hostel items for the school’s pupils. But there is one major obstacle – transporting the items to the school. So, if you are physically fit and want to join the next hike with this arduous task - click Apply to register.', 1, 'Mary Michael', '601332444000', 8, 'https://firebasestorage.googleapis.com/v0/b/sehati-sejiwa.appspot.com/o/photo-1596817120625-7695129a2c92.jfif?alt=media&token=e2002059-1caa-4e61-b845-514ffbb8a3a1'), ('Humanitarian, Disaster & Crisis Management Volunteer Recruitment', '2020-02-29', 'active', 'The Altruistik Malaysia Humanitarian, Disaster, & Crisis Management open the opportunity for all legally resident in Malaysia, to carry out an national/international volunteer service in Malaysia, Europe, Africa, Asia or South America affected area. Interested applicant click on Apply button to register.', 2, 'Tommy Lee', '603700012', 6, 'https://firebasestorage.googleapis.com/v0/b/sehati-sejiwa.appspot.com/o/41465112-volunteer-charity-help-sharing-giving-donate-assisting-concept.jpg?alt=media&token=d0079208-eaaf-45c8-b89b-529b29608b2b'), ('Autism (ASD) Activist Recruitment', '2020-02-29', 'active', 'Call for State(Malaysia) Autism Spectrum Disorder SDG4 Activist. This project envisions to refocused effort to improve the quality of the education and acceptance among-st the community towards ASD. Acceptance in education along the lines of gender, urban-rural location and other dimensions still run deep, and more investments in education infrastructure are required.This campaign intends to enroll 80 State Activist across the Malaysia and raise voice in form of solidarity.', 2, 'Salina Salleh', '6037000011', 8, 'https://firebasestorage.googleapis.com/v0/b/sehati-sejiwa.appspot.com/o/fadi-xd-I4dR572y7l0-unsplash.jpg?alt=media&token=60b13f56-26df-4831-8e14-ea819da84252'); "
