...
<<<<<<< HEAD
    + "insert into users (email, firstname, lastname, password, organization_id) values ('cikguharry@gmail.com', 'Harry', 'Baikal', '$2b$07$49aRDpd9GFjGn8vgt0NxNu7phrRn3UHN.6mRJybaESNceGyknbKfe', 1), ('myaltruistik@gmail.com', 'Logesh Kumar ', 'Sethuraman', '$2b$07$LwVuRvHH7comkN2KcH3D1emTZA6LnhpNQpVpVQaE0DAfE7EUzMHbW', 2), ('test@abc.com', 'Esme', 'And Friend', '$2b$07$49aRDpd9GFjGn8vgt0NxNu7phrRn3UHN.6mRJybaESNceGyknbKfe', 4);"
...
=======
    + "insert into users (email, firstname, lastname, password, organization_id) values ('cikguharry@gmail.com', 'Harry', 'Baikal', '$2b$07$49aRDpd9GFjGn8vgt0NxNu7phrRn3UHN.6mRJybaESNceGyknbKfe', 1), ('myaltruistik@gmail.com', 'Logesh Kumar ', 'Sethuraman', '$2b$07$LwVuRvHH7comkN2KcH3D1emTZA6LnhpNQpVpVQaE0DAfE7EUzMHbW', 2);"
    + "insert into events (name, closingdate, status, description, organizer_id, contactname, contactnum, totalvolunteer, images) values ('Programme Charity Hike 2020', '2021-12-1', 'active', 'Malaysians who are moved by the inspiring story of a teacher that carried a refrigerator for 10km on foot to a remote school are encouraged to join him on another arduous task. JCI Kota Kinabalu, a non-governmental organisation, has donated more than 20 mattresses and hostel items for the school’s pupils. But there is one major obstacle – transporting the items to the school. So, if you are physically fit and want to join the next hike with this arduous task - click Apply to register.', 1, 'Mary Michael', '601332444000', 8, 'https://images.unsplash.com/photo-1596817120625-7695129a2c92?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=334&q=80'), ('Humanitarian, Disaster & Crisis Management Volunteer Recruitment', '2020-02-29', 'active', 'The Altruistik Malaysia Humanitarian, Disaster, & Crisis Management open the opportunity for all legally resident in Malaysia, to carry out a national/ international volunteer service in Malaysia, Europe, Africa, Asia or South America affected area. Interested applicant click on Apply button to register.', 2, 'Tommy Lee', '603700012', 6, 'https://images.pexels.com/photos/6646897/pexels-photo-6646897.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940'), ('Autism (ASD) Activist Recruitment', '2020-02-29', 'active', 'Call for State(Malaysia) Autism Spectrum Disorder SDG4 Activist. This project envisions to refocused effort to improve the quality of the education and acceptance among-st the community towards ASD. Acceptance in education along the lines of gender, urban-rural location and other dimensions still run deep, and more investments in education infrastructure are required.This campaign intends to enroll 80 State Activist across the Malaysia and raise voice in form of solidarity.', 2, 'Salina Salleh', '6037000011', 8, 'https://images.unsplash.com/photo-1488521787991-ed7bbaae773c?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1050&q=80'); "
>>>>>>> br-staging
